...
document.getElementById('column1').innerHTML = "<h2>Holy Moly! I changed the page!</h2>";

document.getElementById('column1').innerHTML += "<p>wow I can add more to it!!</p>";

document.getElementById('column1').innerHTML += "<p>My students are soooo cool!</p>";
...
var damage;
//if the weapon is squid then the damage points is 50
//but is weapon is dogs the damage is 25
//otherwise the damage is 0
...
if(health==0){
    document.getElementById('column3').innerHTML += "<p>You got 'em bruh, GG</p>";

}
else { 
    document.getElementById('column3').innerHTML += "<p>The opponent still stands</p>";
}
